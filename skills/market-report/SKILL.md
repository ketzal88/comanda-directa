---
name: market-report
description: Arma el reporte de AUDITORÍA del cliente en Markdown: compila los resultados de las auditorías previas en un documento con scores, hallazgos, recomendaciones y plan de acción priorizado con impacto estimado en revenue. Usar cuando Gabriel pida "compilá la auditoría de", "armá el informe de la auditoría", o después de correr una o más skills de audit. NO usar para el cierre de mes con datos del Brain: eso es reporte-mensual. Para la versión PDF ver market-report-pdf; para publicarlo al cliente en HTML ver worker-proposals.
---
