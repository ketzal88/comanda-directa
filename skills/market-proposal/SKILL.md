...
description: Arma el CONTENIDO de una propuesta comercial de servicios de marketing: discovery questions, alcance, pricing con anchoring y opciones por tiers, y proyección de ROI. Usar cuando Gabriel pida "armá una propuesta comercial", "cotización para", "pasame el pricing de", o después de un discovery call para formalizar el engagement. Para el FORMATO HTML y la publicación en brain.worker.ar, ver la skill worker-proposals.
---
