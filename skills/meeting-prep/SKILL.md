---
name: meeting-prep
description: Genera un brief pre-reunión. Investiga a los participantes, junta el contexto del cliente, arma la agenda y propone preguntas filosas. Usar cuando Gabriel diga "prepará la reunión con", "tengo un call con", "mañana me junto con", "brief para la reunión de [cliente]", o pida prep para una llamada o pitch.
---
