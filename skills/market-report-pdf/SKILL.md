...
description: Genera el reporte de marketing en PDF via scripts/generate_pdf_report.py, con gauges de score, gráficos de barras, tablas comparativas y plan de acción priorizado. Usar cuando Gabriel pida "el reporte en PDF", "pasame el reporte para presentar", o necesite el deliverable para una presentación con el cliente. Para la versión Markdown ver market-report.
---
